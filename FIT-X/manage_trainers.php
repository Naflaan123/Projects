...
// Query to select all trainer details from the tbltrainers table
$sql = "SELECT UserID, Username, Email, Password, Specialization FROM tbltrainers";
...
<head>
   ...
   <title>Manage Trainers - Fit-X</title>
...
<body>
    ...
    <section class="trainer-report">
        <?php
        if ($result->num_rows > 0) {
            echo "<table>";
            echo "<tr><th>User ID</th><th>Username</th><th>Email</th><th>Password</th><th>Specialization</th></tr>";
            ...
            echo "<p>No trainer data available.</p>";
        }
        ?>
    </section>
